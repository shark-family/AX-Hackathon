...
% [섹션 1: 핵심 역량]
% ====================================================================
%\begin{cvsection}{자기 소개}
%    \begin{itemize}[leftmargin=*, noitemsep, topsep=0pt]
%    \BLOCK{ for item in introduction }
%        \item \VAR{item}
%    \BLOCK{ endfor }
%    \end{itemize}
%\end{cvsection}
...
\begin{cvsection}{경력 사항}
    ...
    \begin{minipage}[t]{0.75\textwidth}
        ...
        \textbf{\textit{\small \VAR{job.role}}}
    \end{minipage}%
    \hfill
    ...
    \begin{itemize}[leftmargin=1.2em, itemsep=2pt, topsep=0pt]
        ...
        \item {\VAR{detail.title}}
            \begin{itemize}[label=-, topsep=0pt]
                \BLOCK{ for sub in detail.descriptions }
                \item \VAR{sub}
                \BLOCK{ endfor }
            \end{itemize}
        \BLOCK{ endfor }
...
\begin{cvsection}{학력}
    ...
    \noindent \textbf{{\VAR{edu.institution}}} \hfill \textbf{\textit{\VAR{edu.period}}} \\
